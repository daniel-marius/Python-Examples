...
SCRYPT_ARRAY_SIZE = 1024
BOOTSTRAP_LIST = ["localhost:5000"]
...
def get_ui():
    return send_from_directory('ui', 'peer2.html')


@app.route('/network', methods=['GET'])
def get_network():
    return send_from_directory('ui', 'network2.html')
...
def get_balance():
    balance = blockchain_obj.get_balance()
